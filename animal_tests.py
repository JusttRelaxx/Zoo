...
class TestAnimal(unittest.TestCase):
    ...
    def test_animal_init(self):
        animal = Animal("panda", 1, "Ivo", "male", 300, 6, "bamboo", 10, 0.2, 20)
    ...
    def test_animal_save(self):
        animal1 = Animal("panda", 1, "Ivo", "male", 300, 6, "bamboo", 10, 0.2, 20)
        animal2 = Animal("bear", 2, "Mecho", "male", 400, 3, "meat", 12, 0.4, 25)
